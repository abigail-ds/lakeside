...
Behind the wheel classes are held in pairs. Maximum of two students and the teacher. Total of 3 individuals.   Masks  are required. We can provide you some if needed. At the end of a lesson, the car is sanitized before it is used for another session.

For the classroom - classes are being conducted with 10 in person students. For the safety of our clients, Lakeside Driving School is offering private sessions 7 days a week, based on availability for the driver improvement and re-examination class. There are reasonable spaces between clients during class.  Online Driver's Education Course is coming SOON!
